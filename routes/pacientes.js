...
router.get('/', (req, res) => {
  res.render('layout', { title: '', body: '', showBodyImage: true }); // Adiciona a variável showBodyImage
});
...
router.get('/pacientes', async (req, res) => {
  try {
    ...
    // Garanta que 'diaMarcado' seja um objeto Date
...
// Rota para exibir o formulário de exclusão de paciente
